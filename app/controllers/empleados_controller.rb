class EmpleadosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @empleado.update(empleado_params)
        format.html { redirect_to empleados_path, notice: 'Empleado actualizado.' }
  ...
  def destroy
    @empleado.destroy
    respond_to do |format|
      format.html { redirect_to empleados_url, notice: 'Empleado borrado.' }
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(:nombre, :email, :status)
    end
