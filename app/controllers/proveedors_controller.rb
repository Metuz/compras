class ProveedorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @proveedor.save
        format.html { redirect_to @proveedor, notice: 'Proveedor creado.' }
  ...
  def update
    respond_to do |format|
      if @proveedor.update(proveedor_params)
        format.html { redirect_to @proveedor, notice: 'Proveedor actualizado.' }
  ...
  def destroy
    @proveedor.destroy
    respond_to do |format|
      format.html { redirect_to proveedors_url, notice: 'Proveedor borrado.' }
  ...
  private
    ...
    def proveedor_params
      params.require(:proveedor).permit(:empresa, :nombre, :direccion, :cp, :telefono, :rfc, :contacto)
    end
end
