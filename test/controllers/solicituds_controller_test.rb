...
class SolicitudsControllerTest < ActionController::TestCase
  ...
  test "should create solicitud" do
    assert_difference('Solicitud.count') do
      post :create, solicitud: { empleado_id: @solicitud.empleado_id, pin: @solicitud.pin, proyecto_id: @solicitud.proyecto_id }
    end
  ...
  test "should update solicitud" do
    patch :update, id: @solicitud, solicitud: { empleado_id: @solicitud.empleado_id, pin: @solicitud.pin, proyecto_id: @solicitud.proyecto_id }
    assert_redirected_to solicitud_path(assigns(:solicitud))
  end
