...
class ProveedorsControllerTest < ActionController::TestCase
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post :create, proveedor: { contacto: @proveedor.contacto, cp: @proveedor.cp, direccion: @proveedor.direccion, empresa: @proveedor.empresa, nombre: @proveedor.nombre, rfc: @proveedor.rfc, telefono: @proveedor.telefono }
    end
  ...
  test "should update proveedor" do
    patch :update, id: @proveedor, proveedor: { contacto: @proveedor.contacto, cp: @proveedor.cp, direccion: @proveedor.direccion, empresa: @proveedor.empresa, nombre: @proveedor.nombre, rfc: @proveedor.rfc, telefono: @proveedor.telefono }
    assert_redirected_to proveedor_path(assigns(:proveedor))
  end
